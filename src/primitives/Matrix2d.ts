...
export class Matrix2d {
  ...
  static Rotate(r: number, cx?: number, cy?: number) {
    ...
    const rotationMatrix2d = new Matrix2d(
      cosAngle,
      sinAngle,
      -sinAngle,
      cosAngle,
  ...
  static toCssString(m: MatLike) {
    return `matrix(${toDomPrecision(m.a)}, ${toDomPrecision(
      m.b
    )}, ${toDomPrecision(m.c)}, ${toDomPrecision(m.d)}, ${toDomPrecision(
      m.e
    )}, ${toDomPrecision(m.f)})`;
  }
