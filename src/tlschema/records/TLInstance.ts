...
import { TLCursor, cursorValidator } from "../misc/TLCursor";
import { TLScribble, scribbleValidator } from "../misc/TLScribble";
import { Box2dModel } from "../misc/geometry-types";
import { idValidator } from "../misc/id-validator";
import { TLPageId, pageIdValidator } from "./TLPage";
...
export const instanceMigrations = defineMigrations({
  ...
  migrators: {
    ...
    [Versions.AddVerticalAlign]: {
      ...
      down: (instance: TLInstance) => {
        const { verticalAlign: _, ...propsForNextShape } =
          instance.propsForNextShape;
        return {
          ...instance,
          propsForNextShape,
